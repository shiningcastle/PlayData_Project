...
<body>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="team-item">
						<div class="team-content">
							<i><img src="assets/images/testimonial-icon.png" alt=""></i>
							<p>
								매우 꿀알바 입니다. 근무 중 개인공부 가능합니다.<br> 근데 시급이 너무짜요<br>
								<br>
							</p>
							<div class="user-image">
								<img src="http://placehold.it/60x60" alt="">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="team-item">
						<div class="team-content">
							<i><img src="assets/images/testimonial-icon.png" alt=""></i>
							<p>
								목돈벌고 탈주하기 좋은알바! <br>할만한데 장난감회사다 보니 진상이 너무 많아요<br>
							</p>
							<div class="user-image">
								<img src="http://placehold.it/60x60" alt="">
							</div>
	...
	<section class="section colored" id="pricing-plans">
		<div class="container">
			...
			<div class="row">
				...
				<div class="offset-lg-3 col-lg-6">
					<div class="center-text">
						<p>Part-time jobs can help people make money to pay off debt,
							save for emergencies or other financial goals, or provide an
							extra cushion for things like hobbies, travel, or special
							occasions. While it’s still possible to find part-time jobs by
							responding to classifieds, through word of mouth, or via local
							flyers, it’s now faster and easier than ever to find part-time
							work through online job sites.</p>
					</div>
				</div>
			</div>
			<!-- ***** Section Title End ***** -->
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-12"
					...
					<div class="pricing-item">
						...
						<div class="pricing-footer">
							<a class="main-button" style="color: white;"
								onclick="location.href='workman?command=ptlist&listnum=${sessionScope.ptlistall[0].listnum}&companyname=${sessionScope.ptlistall[0].companyname.companyname}'">더
								알아보기</a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12"
					...
					<div class="pricing-item active">
						...
						<div class="pricing-footer">
							<a class="main-button" style="color: white;"
								onclick="location.href='workman?command=ptlist&listnum=${sessionScope.ptlistall[1].listnum}&companyname=${sessionScope.ptlistall[1].companyname.companyname}'">더
								알아보기</a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12"
					...
					<div class="pricing-item">
						...
						<div class="pricing-footer">
							<a class="main-button" style="color: white;"
								onclick="location.href='workman?command=ptlist&listnum=${sessionScope.ptlistall[3].listnum}&companyname=${sessionScope.ptlistall[3].companyname.companyname}'">더
								알아보기</a>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div
					...
					<div class="left-heading">
						...
						<h2 class="section-title" style = "left: 500px;">전국 구인구직 현황</h2>
					</div>
					<div class="left-text">
						<p>
	...
	<footer>
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<p class="copyright">WORKMAN &copy; 서울특별시 서초구 서초동 서초대로46길 42
						엔코아타워 | 02-1234-5678 | workman@work.co.kr</p>
				</div>
			</div>
		</div>
	</footer>
